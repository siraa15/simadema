<section class="content-header">
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body">
					<table id="konseptema" class="table table-striped table-bordered">
            <thead>
						<tr>
            ...
            <tbody>
             ...
             JOIN substansi ON formkonseptema.id_substansi=substansi.id_substansi join user on user.iduser=formkonseptema.iduser where level='Asisten Pratama'");
            ...
            $no = 0; //variabel no untuk nomor urutnya.
              ...
              if($d['statusapprove']=="wait kasisten"){
                echo "<a href='datamasuk/konseptema/proses_approve.php?id_konseptema=$d[id_konseptema]' class='btn btn-danger' onclick = \" return confirm('Yakin Approve Data Ini'); \"><i class='fas fa-clock'></i></a>";
              }else{
