    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body">
					...
					<table id="pemetaanhasil" class="table table-striped table-bordered">
            <thead>
						<tr>
            ...
            <tbody>
             ...
             JOIN substansi ON formpemetaanhasil.id_substansi=substansi.id_substansi join user on user.iduser=formpemetaanhasil.iduser where level='Asisten Pratama'");
            ...
            $no = 0; //variabel no untuk nomor urutnya.
              ...
              if($d['statusapprove']=="wait kasisten"){
                echo "<a href='datamasuk/pemetaanhasil/proses_approve.php?id_pemetaanhasil=$d[id_pemetaanhasil]' class='btn btn-danger' onclick = \" return confirm('Yakin Approve Data Ini'); \"><i class='fas fa-clock'></i></a>";
              }else{
