      ...
      <div class="card">
        <div class="card-body">
            ...
            <tbody>
             ...
             JOIN substansi ON formpemetaanlaporan.id_substansi=substansi.id_substansi join user on user.iduser=formpemetaanlaporan.iduser where level='Asisten Pratama'");
            ...
            $no = 0; //variabel no untuk nomor urutnya.
              ...
              if($d['statusapprove']=="wait kasisten"){
                echo "<a href='datamasuk/pemetaandatalaporan/proses_approve.php?id_pemetaanlaporan=$d[id_pemetaanlaporan]' class='btn btn-danger' onclick = \" return confirm('Yakin Approve Data Ini'); \" ><i class='fas fa-clock'></i></a>";
              }else{
