      ...
      <div class="card">
        <div class="card-body">
            ...
            <tbody>
             ...
             JOIN substansi ON formpemetaanregulasi.id_substansi=substansi.id_substansi join user on user.iduser=formpemetaanregulasi.iduser where level='Asisten Pratama'");
            ...
            $no = 0; //variabel no untuk nomor urutnya.
              ...
              if($d['statusapprove']=="wait kasisten"){
                echo "<a href='datamasuk/pemetaanregulasi/proses_approve.php?id_pemetaanregulasi=$d[id_pemetaanregulasi]' class='btn btn-danger' onclick = \" return confirm('Yakin Approve Data Ini'); \"><i class='fas fa-clock'></i></a>";
              }else{
