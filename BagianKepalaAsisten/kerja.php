...
else
{
  ...
  else if($_GET['page']=='data_konseptema_edit_simpan')
  {
   include 'datalaporan/konseptema/data_konseptema_edit_simpan.php';
    ...
    // Menu Registrasi Laporan Bawah

     // Menu Data Masuk Atas
  else if($_GET['page']=='datamasuk_konseptema_pm')
  {
  include 'datamasuk/konseptema/data_konseptema_pm.php';
  }
  else if($_GET['page']=='datamasuk_pemetaandatalaporan')
  {
  include 'datamasuk/pemetaandatalaporan/data_pemetaanlaporan.php';
  }
  else if($_GET['page']=='datamasuk_pemetaanisu')
  {
  include 'datamasuk/pemetaanisupelayananpublik/data_pemetaanisu.php';
  }
  else if($_GET['page']=='datamasuk_pemetaaninformasi')
  {
  include 'datamasuk/pemetaaninformasi/data_pemetaaninformasi.php';
  }
  else if($_GET['page']=='datamasuk_pemetaanhasil')
  {
  include 'datamasuk/pemetaanhasil/data_pemetaanhasil.php';
  }
  else if($_GET['page']=='datamasuk_pemetaanregulasi')
  {
  include 'datamasuk/pemetaanregulasi/data_pemetaanregulasi.php';
  }
  // MEnu Data Masuk Bawah
    ?>
   <?php
