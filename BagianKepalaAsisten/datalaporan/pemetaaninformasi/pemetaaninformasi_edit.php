<?php
    ...
    $hasil = $db->query("
    select * from formpemetaaninformasi JOIN substansi ON formpemetaaninformasi.id_substansi=substansi.id_substansi where id_pemetaaninformasi = $_GET[id]") or die(mysqli_error($db));
      ...
      <div class="card-body">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Pemetaan Informasi</h3>
            <div class="card-tools"  >
            </div>
          </div>
         
           
          <form action="?page=pemetaaninformasi_edit_simpan" method="POST" class="form-horizontal" >
            <div class="card-body" id=pemetaaninformasi>
            ...
            <div class="form-group row">
                ...
                <input type="hidden" name="id_pemetaaninformasi" value="<?php echo $d['id_pemetaaninformasi'] ?>">
