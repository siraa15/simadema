    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <a href="?page=konseptema_tambah" class="btn btn-primary btn-sm"
             ...
             JOIN substansi ON formkonseptema.id_substansi=substansi.id_substansi join user on user.iduser=formkonseptema.iduser where level='Kepala Asisten Pencegahan' ORDER by 'tanggaldisusun'");
            ...
            $no = 0; //variabel no untuk nomor urutnya.
              ...
              $no++;
                ...
                <a href=../cetak/cetak_konseptema.php?id=$d[id_konseptema]>
