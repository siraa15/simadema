<?php
    ...
    $hasil = $db->query("
    select * from formpemetaanhasil JOIN substansi ON formpemetaanhasil.id_substansi=substansi.id_substansi where id_pemetaanhasil  = $_GET[id]") or die(mysqli_error($db));
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="card card-primary">
          ...
          <form action="?page=pemetaanhasil_edit_simpan" method="POST" class="form-horizontal" >
            ...
            <div class="form-group row">
                ...
                <input type="hidden" name="id_pemetaanhasil" value="<?php echo $d['id_pemetaanhasil'] ?>">
