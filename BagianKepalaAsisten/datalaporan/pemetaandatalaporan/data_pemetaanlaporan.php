      ...
      <div class="card">
        ...
        <a href="?page=pemetaan_tambah" class="btn btn-primary btn-sm"
            ...
            <tbody>
             ...
             JOIN substansi ON formpemetaanlaporan.id_substansi=substansi.id_substansi join user on user.iduser=formpemetaanlaporan.iduser where level='Asisten Muda'");
