...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="https://ombudsman.go.id" class="brand-link">
      <img src="../img/simadema2.png" alt="SIMADEMA LOGO" width=200  class="ml-4 " >
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="?page=datamasuk_konseptema_pm" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Konsep Tema PM</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?page=datamasuk_pemetaandatalaporan" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pemetaan Data Laporan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?page=datamasuk_pemetaanisu" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pemetaan Isu Pelayanan Publik</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?page=datamasuk_pemetaanhasil"  class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pemetaan Hasil Penelitian Akademik</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?page=datamasuk_pemetaanregulasi" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pemetaan Regulasi</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?page=datamasuk_pemetaaninformasi" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pemetaan Informasi</p>
                </a>
              </li>
