      ...
      <div class="card">
        <div class="card-body">
            ...
            <tbody>
             ...
             JOIN substansi ON formpemetaanhasil.id_substansi=substansi.id_substansi join user on user.iduser=formpemetaanhasil.iduser where level='Asisten Muda'");
            ...
            $no = 0; //variabel no untuk nomor urutnya.
              ...
              if($d['statusapprove']=="wait kaper"){
                echo "<a href='datalaporan/pemetaanhasil/proses_approve.php?id_pemetaanhasil=$d[id_pemetaanhasil]' class='btn btn-danger' onclick = \" return confirm('Yakin Approve Data Ini'); \"><i class='fas fa-clock'></i></a>";
              }else{
