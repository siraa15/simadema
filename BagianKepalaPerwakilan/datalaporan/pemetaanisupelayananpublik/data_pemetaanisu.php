      ...
      <div class="card">
        <div class="card-body">
            ...
            if($d['statusapprove']=="wait kaper"){
              echo "<a href='datalaporan/pemetaanisupelayananpublik/proses_approve.php?id_pemetaanisu=$d[id_pemetaanisu]' class='btn btn-danger' onclick = \" return confirm('Yakin Approve Data Ini'); \"><i class='fas fa-clock'></i></a>";
            }else{
