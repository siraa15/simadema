      ...
      <div class="card">
        <div class="card-body">
            ...
            <tbody>
             ...
             JOIN substansi ON formkonseptema.id_substansi=substansi.id_substansi join user on user.iduser=formkonseptema.iduser where level='Asisten Muda'");
            ...
            if($d['statusapprove']=="wait kaper"){
              echo "<a href='datalaporan/konseptema/proses_approve.php?id_konseptema=$d[id_konseptema]' class='btn btn-danger' onclick = \" return confirm('Yakin Approve Data Ini'); \"><i class='fas fa-clock'></i></a>";
            }else{
