<?php
    ...
    $hasil = $db->query("
    select * from formpemetaanregulasi JOIN substansi ON formpemetaanregulasi.id_substansi=substansi.id_substansi where id_pemetaanregulasi  = $_GET[id]") or die(mysqli_error($db));
      ...
      <div class="card-body">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Kompilasi Hasil Survei Terdahulu</h3>
          ...
          <form action="?page=pemetaanregulasi_edit_simpan" method="POST" class="form-horizontal" >
            ...
            <div class="form-group row">
                ...
                <input type="hidden" name="id_pemetaanregulasi" value="<?php echo $d['id_pemetaanregulasi'] ?>">
