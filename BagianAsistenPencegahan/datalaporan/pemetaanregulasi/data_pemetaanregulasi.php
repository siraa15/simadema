  <section class="content-header">
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-body">
          <a href="?page=pemetaanregulasi_tambah" class="btn btn-primary btn-sm"
                style="margin-bottom: 7px;">Tambah Data</a>	
            <table id="datapemetaanregulasi" class="table table-striped table-bordered">
              <thead>
              <tr>
              ...
              JOIN substansi ON formpemetaanregulasi.id_substansi=substansi.id_substansi join user on user.iduser=formpemetaanregulasi.iduser where user.iduser=$iduser");
              ...
              while( $d = $hasil->fetch_assoc() )
              {
                ...
                <tr>
                  ...
                  <td>$d[tema]</td>
                  <td> 
                  <a href=?page=pemetaanregulasi_edit&id=$d[id_pemetaanregulasi]> 
                      <i class='fas fa-pencil-alt'></i> </a>
                  <a href=?page=pemetaanregulasi_hapus&id=$d[id_pemetaanregulasi] 
                      onclick = \" return confirm('Yakin Hapus Data Ini'); \"> 
                      <i class='fas fa-trash-alt'></i> </a>
                  <a href=../cetak/cetak_pemetaanregulasi.php?id=$d[id_pemetaanregulasi] target=__blank>
                  <i class='fas fa-print'></i></a>
                  <a href=../download/cetak_pemetaanregulasi.php?id=$d[id_pemetaanregulasi]>
            ...
            <script>
                $(document).ready(function(){
                    $('#datapemetaanregulasi').DataTable();
                });
            </script>
          </div> <!-- /.card-body -->
