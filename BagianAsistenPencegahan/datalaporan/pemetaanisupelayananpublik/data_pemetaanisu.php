    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <a href="?page=pemetaanisu_tambah" class="btn btn-primary btn-sm"
					...
					<table id="datapemetaanisu" class="table table-striped table-bordered">
            <thead>
						<tr>
            ...
            <tbody>
             ...
             JOIN substansi ON formpemetaanisupelayananpublik.id_substansi=substansi.id_substansi join user on user.iduser=formpemetaanisupelayananpublik.iduser where user.iduser=$iduser");
