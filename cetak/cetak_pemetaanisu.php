...
<?php
	...
	?>
	<title>Format Pemetaan Isu Pelayanan Publik</title>
	<style type="text/css">
		body{
	...
	<center>
		...
		<table width="625">
			<tr>
				<td>
					<br>
					<p align="center"><b><font face="Arial" size="2.5">PEMETAAN ISU PELAYANAN PUBLIK </font></b></p> 
				</td>
		...
		<?php
			$id=$_GET['id'];
			$query = mysqli_query($db,"SELECT * FROM formpemetaanisupelayananpublik join substansi on formpemetaanisupelayananpublik.id_substansi=substansi.id_substansi join user on formpemetaanisupelayananpublik.iduser=user.iduser WHERE id_pemetaanisu='$id'")or die(mysqli_error($db));
