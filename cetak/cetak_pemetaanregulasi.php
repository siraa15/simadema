...
<?php
	...
	?>
	<title>Format Pemetaan Regulasi</title>
	<style type="text/css">
		body{
	...
	<center>
		...
		<table width="625">
			<tr>
				<td>
					<br>
					<p align="center"><b><font face="Arial" size="2.5"> PEMETAAN REGULASI </font></b></p> 
				</td>
		...
		<?php
			$id=$_GET['id'];
			$query = mysqli_query($db,"SELECT * FROM formpemetaanregulasi join substansi on formpemetaanregulasi.id_substansi=substansi.id_substansi join user on formpemetaanregulasi.iduser=user.iduser WHERE id_pemetaanregulasi='$id'")or die(mysqli_error($db));
