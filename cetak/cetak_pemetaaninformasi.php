...
<?php
	...
	?>
	<title>Format Pemetaan Informasi</title>
	<style type="text/css">
		body{
	...
	<center>
		...
		<table width="625">
			<tr>
				<td>
					<br>
					<p align="center"><b><font face="Arial" size="2.5"> PEMETAAN INFORMASI </font></b></p> 
				</td>
		...
		<?php
			$id=$_GET['id'];
			$query = mysqli_query($db,"SELECT * FROM formpemetaaninformasi join substansi on formpemetaaninformasi.id_substansi=substansi.id_substansi join user on formpemetaaninformasi.iduser=user.iduser WHERE id_pemetaaninformasi='$id'")or die(mysqli_error($db));
